...
use commands::{
    CommandContext, context, graph, index, init, mcp, metrics, notes, search, vault, workspace,
};
...
enum Commands {
    ...
    /// Retrieve contextual note and metrics views.
